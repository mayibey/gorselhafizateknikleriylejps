...
await g('Input.dispatchMouseEvent',{type:'mouseMoved',x,y});await bekle(150);
await g('Input.dispatchMouseEvent',{type:'mousePressed',x,y,button:'left',clickCount:1});await bekle(120);
await g('Input.dispatchMouseEvent',{type:'mouseReleased',x,y,button:'left',clickCount:1});
await bekle(3500);
const r=await g('Runtime.evaluate',{expression:'location.href',returnByValue:true});
